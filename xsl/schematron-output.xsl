...
<xsl:stylesheet
	...
	-->
	<xsl:variable name="nrErrors"><xsl:value-of select="count(//failed-assert[@role='error' or @role='fatal'])"/></xsl:variable>
	<xsl:variable name="nrFatals"><xsl:value-of select="count(//failed-assert[@role='fatal'])"/></xsl:variable>
	<xsl:variable name="nrWarnings"><xsl:value-of select="count(//failed-assert[@role='warn' or @role='warning'])"/></xsl:variable>
	<xsl:variable name="nrInfos"><xsl:value-of select="count(//failed-assert[@role='information' or @role='info'])"/></xsl:variable>
	<xsl:variable name="nrReport"><xsl:value-of select="count(//failed-assert[not(@role='information' or @role='info')])"/></xsl:variable>
