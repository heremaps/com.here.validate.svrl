...
<xsl:stylesheet xmlns:xhtml="http://www.w3.org/1999/xhtml"
  ...
  -->
	<xsl:template match="tgroup" mode="tgroup-fop-rules">
		...
		<!--
				tgroup-cols-colspec-mismatch - <tgroup> mismatch - cols attribute does not match
																			 the actual number of colspec elements
		-->
  ...
  -->
	<xsl:template match="row" mode="row-fop-rules">
		...
		<!--
			table-all-rows-filtered	- <table> If an element contains filtered sub elements,
																they must not be all of the filter type.
		-->
  ...
  -->
	<xsl:template match="li" mode="li-fop-rules">
		...
		<!--
			ul-with-no-li-elements	- <ul> If an element contains filtered sub elements,
																they must not be all of the filter type.
		-->
